<?php
    ...
    $res = $pdo->select('select member_id,member_name,nickname from members');
        ...
        <div class="row">
            <div class="large-12 column"> 
                ...
                <table>
                    <thead>
                        <tr>
                            <th width="500">ユーザーID</th>
                            <th width="500">ユーザー名</th>
                            <th width="500">ニックネーム</th>
                            <th width="500"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=$v['nickname']?></td>
                            <td>
                               <form action="user_detail.php" method="post" style="text-align:center;">
                                   <input type="hidden" name="m_id" value="<?=$v['member_id']?>">
